...
public class MinersArmor extends ArmorItem implements PolymerItem {

    private final PolymerModelData itemModel;
    private final PolymerArmorModel armorModel;
    private final Item itemDefault;

    public MinersArmor(EquipmentSlot slot, Identifier model, Identifier armor) {

        super(ArmorMaterials.LEATHER, slot, new Settings().fireproof().group(ItemGroup.TOOLS));
